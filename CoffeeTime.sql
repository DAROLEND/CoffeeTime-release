...
INSERT INTO `cold_drink_items` VALUES (4,'Мохіто','Освіжаючий мохіто з м\'ятою · 500 мл','static/images/menu_items/cold_drinks/mohito.jpg',70.00,0),(5,'Молочний коктейль','Густий молочний коктейль','static/images/menu_items/cold_drinks/lemonade.webp',90.00,0),(6,'Фруктовий коктейль','Свіжий фруктовий коктейль','static/images/menu_items/cold_drinks/smoothie.webp',95.00,0),(7,'Бабл ті','Чай з молоком та тапіокою','static/images/menu_items/default.jpg',100.00,0),(8,'Какао бабл','Какао з молочними бульбашками','static/images/menu_items/default.jpg',110.00,0);
...
INSERT INTO `dessert_items` VALUES (1,'Львівський сирник','Крафтовий, ніжний, з ідеальним балансом смаку','static/images/menu_items/desserts/lviv_sirnik.webp',90.00,1),(2,'Карамельний тарт','Хрумка основа, ніжна карамель і неймовірний шоколад ','static/images/menu_items/desserts/tart.webp',80.00,2),(3,'Мусовий десерт','Шоколад, карамель, велюр — гармонія в кожному шматочку','static/images/menu_items/desserts/muss.webp',110.00,1);
...
-- Dump completed on 2026-06-08  1:58:29
